...
import static com.sensedia.apix2019.microservice.finder.commons.ConfigConstants.RECOMMENDATION_NUMBER_OF_KITS;
...
public class KitResponseBuilder {
    ...
    public KitResponse build(Long id, Gender gender, List<Item> items){
        ...
        final IntStream kitsRange = IntStream.range(0, RECOMMENDATION_NUMBER_OF_KITS);
